...
import com.zhou.demo.config.AlipayConfig;
import com.zhou.demo.controller.request.AliPay;
...
//                queryWrapper.eq("id", outTradeNo);
                String  status = orderService.querySatau(outTradeNo);
                //TODO 订单支付超时
                OrderStatuePo orderStatuePo = new OrderStatuePo();
                orderStatuePo.setId(outTradeNo);
                orderStatuePo.setStatus("1");
                orderService.updateStatue(orderStatuePo);
            }
        }
        return "success";
    }
